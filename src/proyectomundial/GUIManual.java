...
public class GUIManual extends JFrame {
    ...
    private void initComponents() {
        ...
        //Pintar opcion nueva de inicio de sesion
        inicioDeSesion();
    ...
    /**
     * Metodo que pinta la opcion de menu con nombre inicio de sesion, dispuesta
     * para el ultimo parcial BY: Sofi Galvis
     */
    private void inicioDeSesion() {
        btnMenuNuevo.setIcon(new ImageIcon(getClass().getResource("/resources/icons/logoGatito.png"))); //MODIFICAR
        btnMenuNuevo.setText("Inicio de sesión");
        btnMenuNuevo.setForeground(new java.awt.Color(255, 255, 255));

        JLabel vacioMenuNuevo = new JLabel();
        jPanelMenuNuevo.setBackground(new java.awt.Color(17, 41, 63));
    ...
    //Acción de inicio de sesion
    private void accionLoguin() {
        jLabelTop.setText("Inicio de sesion");
        String user = String.valueOf(JOptionPane.showInputDialog(null, "Usuario:"));
        String password = String.valueOf(JOptionPane.showInputDialog(null, "Contraseña:"));

        System.out.println(user);
        System.out.println(password);
        for (int i = 0; i < usuarios.length; i++) {
            //todos los usuarios estan en la 0 y las contraseñas en la 1 columna 
            if (usuarios[i][0].equals(user)) {
                if (usuarios[i][1].equals(password)) {
                    haySesion = true;
                    break;
                } else {
